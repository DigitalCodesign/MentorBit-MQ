/*
  ...
  ╚██████╗   ╚██████╔╝   ██████╔╝   ███████╗   ███████║   ██║   ╚██████╔╝   ██║ ╚████║
   ...
   Descripcion:
      Este sketch es un ejemplo de como medir el valor de CO en ppm usando un
...
// Se crea el objeto mq8
/*
    El sensor MQ puede medir otros tipos de gases diferentes. A continuacion se muestra la sentencia:

    mq8.h2 -> mide las ppm de h2
    mq8.glp -> mide las ppm de glp
    mq8.ch4 -> mide las ppm de ch4
    mq8.co -> mide las ppm de co
    mq8.alcohol -> mide las ppm de alcohol
...
*/
MentorBitMQ8 mq8(mq8.co, MQ_PIN);
...
void loop(){
    ...
    Serial.println("CO:   " + String(mq8.obtenerLecturaMQ()) + " ppm");
