...
// Se crea el objeto mq7
/*
    El sensor MQ puede medir otros tipos de gases diferentes. A continuacion se muestra la sentencia:

    mq7.h2 -> mide las ppm de h2
    mq7.glp -> mide las ppm de glp
    mq7.ch4 -> mide las ppm de ch4
    mq7.co -> mide las ppm de co
    mq7.alcohol -> mide las ppm de alcohol
...
*/
MentorBitMQ7 mq7(mq7.glp, MQ_PIN);
...
void loop(){
    ...
    Serial.println("GLP:   " + String(mq7.obtenerLecturaMQ()) + " ppm");
